...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.887809,2.000000,1.959235,6.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.800000,0.800000,1.000000,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = (Local5 * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000).rg,Parameters.TwoSidedSign));
	MaterialFloat3 Local12 = mul(Local11, Parameters.TangentToWorld);
	MaterialFloat Local13 = dot(Parameters.CameraVector,Local12);
	MaterialFloat Local14 = saturate(Local13);
	MaterialFloat Local15 = (1.00000000 - Local14);
	MaterialFloat Local16 = PositiveClampedPow(Local15,Material.PreshaderBuffer[2].w);
	MaterialFloat Local17 = (Local16 * Material.PreshaderBuffer[3].x);
	MaterialFloat Local18 = (Local14 * Material.PreshaderBuffer[3].y);
	MaterialFloat Local19 = (1.00000000 - Local18);
	MaterialFloat Local20 = (Local19 + 0.00000000);
	MaterialFloat Local21 = (Local17 + Local20);
	MaterialFloat3 Local22 = (((MaterialFloat3)Local21) * Local10);
	MaterialFloat Local23 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local24 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local25 = MaterialStoreTexSample(Parameters, Local24, 0);
	MaterialFloat Local26 = (Local24.g * Material.PreshaderBuffer[3].z);
	...
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[3].w;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(0.00000000.rrr,Material.PreshaderBuffer[4].x);
