...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local8 = Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 0);
	MaterialFloat Local10 = (Local8.g * Material.PreshaderBuffer[2].x);
	MaterialFloat Local11 = saturate(Local10);
	MaterialFloat Local12 = (Local8.b * 0.50000000);
	MaterialFloat Local13 = saturate(Local8.r);
	...
	PixelMaterialInputs.Specular = Local12;
	PixelMaterialInputs.Roughness = Local13;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = MaterialFloat3(0.00000000,0.00000000,1.00000000).rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local8.b;
