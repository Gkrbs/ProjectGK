...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(1.000000,0.529763,0.212043,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,0.083333,0.083333,0.083333);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local22 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat Local24 = (Local22.g * Material.PreshaderBuffer[5].x);
	MaterialFloat Local25 = saturate(Local24);
	MaterialFloat Local26 = (Local22.b * 0.50000000);
	MaterialFloat Local27 = saturate(Local22.r);
	...
	PixelMaterialInputs.Specular = Local26;
	PixelMaterialInputs.Roughness = Local27;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local5;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local22.b;
