...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(1.488051,0.000000,0.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local12 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	...
	MaterialFloat Local16 = (Local12.b * 0.50000000);
	MaterialFloat Local17 = saturate(Local12.r);
	MaterialFloat Local18 = (Local8.a + Material.PreshaderBuffer[3].x);
	MaterialFloat Local19 = (Local18 * Material.PreshaderBuffer[3].y);
	MaterialFloat Local20 = lerp(Material.PreshaderBuffer[3].w,Material.PreshaderBuffer[3].z,Local19);
	...
	MaterialFloat4 Local31 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,Local29,View.MaterialTextureMipBias));
