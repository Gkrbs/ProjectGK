Shader "Unreal/MI_Shower_NN_08b"
{
    Properties
    {
		...
		Material_Texture2D_0( "Custom Normal", 2D ) = "white" {}
		Material_Texture2D_1( "TX_Glass_01a_MASK", 2D ) = "white" {}
		Material_Texture2D_2( "Custom Albedo", 2D ) = "white" {}
		Material_Texture2D_3( "RMA Custom", 2D ) = "white" {}
