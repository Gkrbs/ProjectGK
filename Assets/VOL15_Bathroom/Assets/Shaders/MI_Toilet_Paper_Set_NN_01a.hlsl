...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local17 = PositiveClampedPow(Local12.r,Material.PreshaderBuffer[3].x);
	MaterialFloat Local18 = (Local17 * Material.PreshaderBuffer[3].y);
	MaterialFloat Local19 = saturate(Local18);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[3].z;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(0.00000000.rrr,Material.PreshaderBuffer[3].w);
