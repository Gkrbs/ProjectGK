...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(1.000000,0.532732,0.161475,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local20 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local21 = MaterialStoreTexSample(Parameters, Local20, 0);
	MaterialFloat Local22 = (Local20.g * Material.PreshaderBuffer[4].y);
	MaterialFloat Local23 = saturate(Local22);
	MaterialFloat Local24 = (Local20.b * 0.50000000);
	MaterialFloat Local25 = saturate(Local20.r);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[4].z;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local18;
	PixelMaterialInputs.Metallic = Local23;
	PixelMaterialInputs.Specular = Local24;
	PixelMaterialInputs.Roughness = Local25;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local5;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(0.00000000.rrr,Material.PreshaderBuffer[4].w);
	PixelMaterialInputs.AmbientOcclusion = Local20.b;
