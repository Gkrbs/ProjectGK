Shader "Unreal/MI_StatuePillar_Upper_01a"
{
    Properties
    {
		...
		Material_Texture2D_1( "Main_ORM(E)", 2D ) = "white" {}
		Material_Texture2D_2( "Main_Albedo", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_StatuePillar_Upper_01a.hlsl"
