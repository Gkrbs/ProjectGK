Shader "Unreal/MI_Guardrail_base"
{
    Properties
    {
		...
		Material_Texture2D_5( "Diffuse Mat 3", 2D ) = "white" {}
		Material_Texture2D_6( "Diffuse Mat 2", 2D ) = "white" {}
		Material_Texture2D_7( "Diffuse Mat 1", 2D ) = "white" {}
		Material_Texture2D_8( "Ambient Occlusion Base", 2D ) = "white" {}
		Material_Texture2D_9( "Roughness / AO Mat 3", 2D ) = "white" {}
		Material_Texture2D_10( "Roughness / AO Mat 2", 2D ) = "white" {}
		Material_Texture2D_11( "Roughness / AO Mat 1", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Guardrail_base.hlsl"
