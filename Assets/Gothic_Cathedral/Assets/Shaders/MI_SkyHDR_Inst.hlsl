...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.475950,0.208333,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local6 = lerp(Local4,((MaterialFloat3)Local5),Material.PreshaderBuffer[0].y);
	MaterialFloat3 Local7 = (Local6 * Material.PreshaderBuffer[1].xyz);
	MaterialFloat3 Local8 = lerp(Local7,Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].w);
