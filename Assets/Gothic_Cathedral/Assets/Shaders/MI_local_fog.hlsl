...
{
	Material.PreshaderBuffer[0] = float4(0.000034,0.000034,0.000034,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.567708,0.567708,0.567708,0.007000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = WSMultiplyDemote(DERIV_BASE_VALUE(Local2), GetWorldToLocal(Parameters));
	MaterialFloat3 Local4 = CustomExpression0(Parameters);
	MaterialFloat3 Local5 = (DERIV_BASE_VALUE(Local3) - Local4);
	MaterialFloat3 Local6 = CustomExpression1(Parameters);
	MaterialFloat3 Local7 = (Local6 - Local4);
	MaterialFloat3 Local8 = (Local5 / Local7);
	MaterialFloat3 Local9 = (Local8 - ((MaterialFloat3)0.50000000));
	MaterialFloat Local10 = length(Local9);
	MaterialFloat Local11 = (Local10 * Material.PreshaderBuffer[2].w);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Local11;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[3].x);
