Shader "Unreal/MI_Wall_foundation"
{
    Properties
    {
		...
		Material_Texture2D_7( "Ambient Occlusion Base", 2D ) = "white" {}
		Material_Texture2D_8( "Snow / Moss Diffuse", 2D ) = "white" {}
		Material_Texture2D_9( "Roughness / AO Mat 2", 2D ) = "white" {}
		Material_Texture2D_10( "Roughness / AO Mat 1", 2D ) = "white" {}
		Material_Texture2D_11( "Snow / Moss Roughness AO Height", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Wall_foundation.hlsl"
