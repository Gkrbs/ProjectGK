Shader "Unreal/MI_Poppy_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "Atlas_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Atlas_Base_Color", 2D ) = "white" {}
		Material_Texture2D_2( "Atlas_Roughness_AO_Height", 2D ) = "white" {}
		Material_Texture2D_3( "Atlas_Base_Subsurface", 2D ) = "white" {}
