Shader "Unreal/MI_Old_wood_door_small_door"
{
    Properties
    {
		...
		Material_Texture2D_2( "Disrt mask", 2D ) = "white" {}
		Material_Texture2D_3( "Roughness /Metallic / AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Old_wood_door_small_door.hlsl"
