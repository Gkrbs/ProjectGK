Shader "Unreal/MI_Cobblestone_road_nodirt"
{
    Properties
    {
		...
		Material_Texture2D_1( "Snow / Moss Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Base Color", 2D ) = "white" {}
		Material_Texture2D_3( "Snow / Moss Diffuse", 2D ) = "white" {}
		Material_Texture2D_4( "Roughness /Metallic / AO", 2D ) = "white" {}
		Material_Texture2D_5( "Snow / Moss Roughness AO Height", 2D ) = "white" {}
		Material_Texture2D_6( "Good64x64TilingNoiseHighFreq", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Cobblestone_road_nodirt.hlsl"
