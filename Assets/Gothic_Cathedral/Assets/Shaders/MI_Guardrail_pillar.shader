Shader "Unreal/MI_Guardrail_pillar"
{
    Properties
    {
		...
		Material_Texture2D_0( "Base Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Normal Mat 3", 2D ) = "white" {}
		Material_Texture2D_2( "Normal Mat 2", 2D ) = "white" {}
		Material_Texture2D_3( "Normal Mat 1", 2D ) = "white" {}
		Material_Texture2D_4( "RGA Mask", 2D ) = "white" {}
		Material_Texture2D_5( "Snow / Moss Normal", 2D ) = "white" {}
		Material_Texture2D_6( "Diffuse Mat 3", 2D ) = "white" {}
		Material_Texture2D_7( "Diffuse Mat 2", 2D ) = "white" {}
		Material_Texture2D_8( "Diffuse Mat 1", 2D ) = "white" {}
		Material_Texture2D_9( "Ambient Occlusion Base", 2D ) = "white" {}
		Material_Texture2D_10( "Snow / Moss Diffuse", 2D ) = "white" {}
		Material_Texture2D_11( "Roughness / AO Mat 3", 2D ) = "white" {}
		Material_Texture2D_12( "Roughness / AO Mat 2", 2D ) = "white" {}
		Material_Texture2D_13( "Roughness / AO Mat 1", 2D ) = "white" {}
		Material_Texture2D_14( "Snow / Moss Roughness AO Height", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Guardrail_pillar.hlsl"
