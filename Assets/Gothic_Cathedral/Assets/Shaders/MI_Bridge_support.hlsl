...
{
	Material.PreshaderBuffer[0] = float4(12.000000,0.000000,14.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(10.000000,0.000000,1.500000,-0.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(-0.800000,12.000000,0.537204,-0.178126);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.890625,0.890625,0.890625,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,0.682292,0.682292,0.682292);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.000000,0.950000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.880208,0.880208,0.880208,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(1.000000,0.700000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.139395,0.239583,0.069696,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.300000,1.500000,0.150000,0.500000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local80 = (Material.PreshaderBuffer[8].y * Local27.a);
	MaterialFloat3 Local81 = lerp(Local79,Material.PreshaderBuffer[9].xyz,Local80);
	MaterialFloat Local82 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local43), 11);
	MaterialFloat4 Local83 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_9,GetMaterialSharedSampler(samplerMaterial_Texture2D_9,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local43)));
	MaterialFloat Local84 = MaterialStoreTexSample(Parameters, Local83, 11);
	MaterialFloat3 Local85 = (Material.PreshaderBuffer[10].xyz * Local83.rgb);
	MaterialFloat3 Local86 = (((MaterialFloat3)Material.PreshaderBuffer[10].w) * Local85);
	MaterialFloat Local87 = dot(WorldNormalCopy,normalize(MaterialFloat3(0.00000000,0.00000000,1.00000000).rgb));
	MaterialFloat Local88 = (Local87 * 0.50000000);
	MaterialFloat Local89 = (Local88 + 0.50000000);
	MaterialFloat Local90 = (Local89 * Material.PreshaderBuffer[2].z);
	MaterialFloat Local91 = (Local90 + Material.PreshaderBuffer[2].w);
	MaterialFloat Local92 = saturate(Local91);
	MaterialFloat3 Local93 = lerp(Local81,Local86,Local92);
	MaterialFloat3 Local94 = PositiveClampedPow(Local93,((MaterialFloat3)Material.PreshaderBuffer[11].x));
	MaterialFloat3 Local95 = saturate(Local94);
	MaterialFloat3 Local96 = (Local95 * ((MaterialFloat3)Material.PreshaderBuffer[11].y));
	MaterialFloat3 Local97 = (((MaterialFloat3)1.00000000) - Local96);
	MaterialFloat3 Local98 = (((MaterialFloat3)Material.PreshaderBuffer[11].z) * Local97);
	MaterialFloat Local99 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 15);
	MaterialFloat4 Local100 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_10,GetMaterialSharedSampler(samplerMaterial_Texture2D_10,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local0)));
	MaterialFloat Local101 = MaterialStoreTexSample(Parameters, Local100, 15);
	MaterialFloat Local102 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 9);
	MaterialFloat4 Local103 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_11,GetMaterialSharedSampler(samplerMaterial_Texture2D_11,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local16)));
	MaterialFloat Local104 = MaterialStoreTexSample(Parameters, Local103, 9);
	MaterialFloat Local105 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local22), 8);
	MaterialFloat4 Local106 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_12,GetMaterialSharedSampler(samplerMaterial_Texture2D_12,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local22)));
	MaterialFloat Local107 = MaterialStoreTexSample(Parameters, Local106, 8);
	MaterialFloat Local108 = lerp(Local103.r,Local106.r,Local30.r);
	MaterialFloat3 Local109 = lerp(Local100.rgb,((MaterialFloat3)Local108),Local34.r);
	MaterialFloat Local110 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local43), 13);
	MaterialFloat4 Local111 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_13,GetMaterialSharedSampler(samplerMaterial_Texture2D_13,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local43)));
	MaterialFloat Local112 = MaterialStoreTexSample(Parameters, Local111, 13);
	MaterialFloat3 Local113 = lerp(Local109,((MaterialFloat3)Local111.r),Local92);
	MaterialFloat Local114 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	MaterialFloat4 Local115 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_14,GetMaterialSharedSampler(samplerMaterial_Texture2D_14,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local0)));
	MaterialFloat Local116 = MaterialStoreTexSample(Parameters, Local115, 3);
	MaterialFloat Local117 = (1.00000000 - Local115.r);
	MaterialFloat Local118 = (Local117 * 2.00000000);
	MaterialFloat Local119 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 9);
	MaterialFloat4 Local120 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_11,GetMaterialSharedSampler(samplerMaterial_Texture2D_11,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local0)));
	MaterialFloat Local121 = MaterialStoreTexSample(Parameters, Local120, 9);
	MaterialFloat Local122 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local123 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_12,GetMaterialSharedSampler(samplerMaterial_Texture2D_12,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local0)));
	MaterialFloat Local124 = MaterialStoreTexSample(Parameters, Local123, 8);
	MaterialFloat Local125 = lerp(Local120.g,Local123.g,Local30.r);
	MaterialFloat Local126 = lerp(Local100.g,Local125,Local34.r);
	MaterialFloat Local127 = (1.00000000 - Local126);
	MaterialFloat Local128 = (Local118 * Local127);
	MaterialFloat Local129 = (1.00000000 - Local128);
	MaterialFloat Local130 = (Local115.r * 2.00000000);
	MaterialFloat Local131 = (Local130 * Local126);
	MaterialFloat Local132 = select((Local115.r.r >= 0.50000000), Local129.r, Local131.r);
	MaterialFloat3 Local133 = lerp(MaterialFloat3(MaterialFloat2(Local132,Local132),Local132),((MaterialFloat3)Local111.g),Local92);
	MaterialFloat3 Local134 = lerp(Local133,((MaterialFloat3)Material.PreshaderBuffer[12].x),Material.PreshaderBuffer[11].w);
	MaterialFloat3 Local135 = PositiveClampedPow(Local134,((MaterialFloat3)Material.PreshaderBuffer[12].y));
	...
	PixelMaterialInputs.Specular = Local98;
	PixelMaterialInputs.Roughness = Local113;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local55;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local135;
