Shader "Unreal/MI_Bridge_support"
{
    Properties
    {
		...
		Material_Texture2D_9( "Snow / Moss Diffuse", 2D ) = "white" {}
		Material_Texture2D_10( "Roughness / AO Mat 3", 2D ) = "white" {}
		Material_Texture2D_11( "Roughness / AO Mat 2", 2D ) = "white" {}
		Material_Texture2D_12( "Roughness / AO Mat 1", 2D ) = "white" {}
		Material_Texture2D_13( "Snow / Moss Roughness AO Height", 2D ) = "white" {}
		Material_Texture2D_14( "Ambient Occlusion Base", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Bridge_support.hlsl"
