...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.500000,1.167044,0.660000,2.537754);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.850000,2.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = (((MaterialFloat3)Material.PreshaderBuffer[1].x) * Local6.rgb);
	...
	MaterialFloat Local12 = (Local10.b * Material.PreshaderBuffer[1].y);
	MaterialFloat Local13 = (Local10.r * Material.PreshaderBuffer[1].w);
	MaterialFloat Local14 = lerp(Material.PreshaderBuffer[2].x,1.00000000,Local10.g);
	MaterialFloat Local15 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local16 = max(0.00000000,Local15);
	MaterialFloat Local17 = (1.00000000 - Local16);
	MaterialFloat Local18 = abs(Local17);
	MaterialFloat Local19 = max(Local18,0.00010000);
	MaterialFloat Local20 = PositiveClampedPow(Local19,Material.PreshaderBuffer[2].y);
	MaterialFloat Local21 = (Local20 * (1.00000000 - 0.04000000));
	MaterialFloat Local22 = (Local21 + 0.04000000);
	MaterialFloat Local23 = lerp(1.00000000,1.51999998,Local22);
	...
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[1].z;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local23,0.0f),Material.PreshaderBuffer[2].z);
