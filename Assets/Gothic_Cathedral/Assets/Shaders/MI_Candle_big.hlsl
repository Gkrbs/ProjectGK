...
{
	Material.PreshaderBuffer[0] = float4(0.094084,1.000000,0.556863,0.180392);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.000000,0.839216,0.521569,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local7 = (Material.PreshaderBuffer[0].x * Local5.g);
	MaterialFloat3 Local8 = (Material.PreshaderBuffer[0].yzw * ((MaterialFloat3)Local7));
	...
	MaterialFloat3 Local13 = (Material.PreshaderBuffer[2].xyz * Local11.rgb);
	...
	PixelMaterialInputs.Specular = 0.40000001;
	PixelMaterialInputs.Roughness = Local5.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local2.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local5.b;
