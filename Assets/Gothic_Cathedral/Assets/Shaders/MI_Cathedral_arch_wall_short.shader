Shader "Unreal/MI_Cathedral_arch_wall_short"
{
    Properties
    {
		...
		Material_Texture2D_1( "Normal Mat 2", 2D ) = "white" {}
		Material_Texture2D_2( "Normal Mat 1", 2D ) = "white" {}
		Material_Texture2D_3( "RGA Mask", 2D ) = "white" {}
		Material_Texture2D_4( "Snow / Moss Normal", 2D ) = "white" {}
		Material_Texture2D_5( "Diffuse Mat 2", 2D ) = "white" {}
		Material_Texture2D_6( "Diffuse Mat 1", 2D ) = "white" {}
		Material_Texture2D_7( "Snow / Moss Diffuse", 2D ) = "white" {}
		Material_Texture2D_8( "Roughness / AO Mat 2", 2D ) = "white" {}
		Material_Texture2D_9( "Roughness / AO Mat 1", 2D ) = "white" {}
		Material_Texture2D_10( "Snow / Moss Roughness AO Height", 2D ) = "white" {}
		Material_Texture2D_11( "Ambient Occlusion Base", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Cathedral_arch_wall_short.hlsl"
